...
public class OptionalClassExamples {
    ...
    private static void isPresentOptionalAPI() {
        Optional<String> opt = Optional.of("Saurabh");
    ...
    private static void orElseOptionalAPI() {
        ...
        // do nothing.
        //
        String name = Optional.ofNullable(nullName).orElse("Saurabh");
    ...
    private static void orElseGetOptionalAPI() {
        String nullName = null;
        String name = Optional.ofNullable(nullName).orElseGet(() -> "Saurabh");
        System.out.println(name);
    }
